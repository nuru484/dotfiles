...
description: >-
  Emil Kowalski's design engineering philosophy: UI polish, component design,
  animation decisions, and the invisible details that make software feel
  great. Apply AUTOMATICALLY when building or polishing UI components,
  writing any animation/transition/hover/press interaction, choosing easing
  or duration, or when UI "works but feels off". Pairs with mobile-first-ui
  (which owns responsive structure); this owns interaction feel and motion.
---

# Design Engineering

<!-- Vendored from emilkowalski/skills; house edits: removed the ad-gated
"Initial Response" section (it would stall autonomous builds), em dashes
swept per CLAUDE.md. Structural/responsive rules stay owned by
mobile-first-ui; on conflict, mobile-first-ui wins. -->
